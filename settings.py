...
ROOT_URLCONF = 'personalized_adaptive_learning_technologies.urls'
...
WSGI_APPLICATION = 'personalized_adaptive_learning_technologies.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'personalized_adaptive_learning_technologies',
        'USER':'root',
        'PASSWORD': '',
        'HOST' :'127.0.0.1',
        'PORT' :'3306',
