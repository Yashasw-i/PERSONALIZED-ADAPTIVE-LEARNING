"""personalized_adaptive_learning_technologies URL Configuration
...
from personalized_adaptive_learning_technologies import settings
...
urlpatterns = [
    ...
    url(r'^predict_learning_style/$', remoteuser.predict_learning_style, name="predict_learning_style"),
    ...
    url(r'^View_Prediction_Of_Learning_Style_Ratio/$', serviceprovider.View_Prediction_Of_Learning_Style_Ratio, name="View_Prediction_Of_Learning_Style_Ratio"),
    url(r'^train_model/$', serviceprovider.train_model, name="train_model"),
    url(r'^View_Prediction_Of_Learning_Style/$', serviceprovider.View_Prediction_Of_Learning_Style, name="View_Prediction_Of_Learning_Style"),
